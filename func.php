...
if (isset($_POST['patsub'])) {
  ...
  foreach ($rows as $row) {
    if ($row[5] == $email && $row[6] == $password) {
      ...
      // $mail->IsHTML(true);
      // $mail->Subject = "Login Successfully ! Send email using Gmail SMTP and PHPMailer";
      // $mail->Body = "
      ...
      //   <h3>----------------------------</h3>
      //   <p>Thankyou for Login!! Have a Nice day.</p>";
